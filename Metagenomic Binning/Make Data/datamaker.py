...
Given 2 genome file in fasta format, break this up into "reads" of random lengths 
...
"reads" will be mixed in with another set of "reads" of another organism.

these "reads" will go into one output file in fasta format, with the read name and 
sequence. 
'''
